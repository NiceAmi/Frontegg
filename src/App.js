...
function App() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await fetch('https://app-6rio1e7ugq0m.frontegg.com/identity/resources/users/me', {
          credentials: 'include',
        });
  ...
  const handleLogout = () => {
    fetch('https://app-6rio1e7ugq0m.frontegg.com/identity/resources/auth/v1/logout', {
      method: 'POST',
      credentials: 'include',
    })
      .then(() => {
